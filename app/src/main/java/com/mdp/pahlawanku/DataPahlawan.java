...
public class DataPahlawan {
    ...
    public static String[][] data = new String[][]{
            ...
            {"Soepomo",
                    ...
                    "https://pelitanusantara.com/wp-content/uploads/2021/03/supomo.jpg"},
            {"Tan Malaka",
            ...
            {"Saitama",
                    "Seorang Pahlawan dari Jepang yang berhasil mengalahkan setiap penjajah dengan satu pukulannya. Saitama menjadi pahlawan tidak karena adanya harga diri, tidak karena ingin menyelamatkan, ataupun Mendapatkan uang. Dia menjadi Pahlawan untuk hobinya. Kebosanannya karena terlalu kuat memicu sebuah keinginan bahwa dia ingin mendapatkan musuh yang setara kekuatan dengannya.",
                    "https://miro.medium.com/max/720/1*2bjwCLaA8TfH40OXcyLNvA.png"
            },
